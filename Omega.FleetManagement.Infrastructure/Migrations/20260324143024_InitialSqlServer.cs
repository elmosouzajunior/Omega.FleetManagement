        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_company_admins_companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadingLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    UnloadingLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    StartKm = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    FinishKm = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_company_admins_CompanyId",
                table: "company_admins",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_company_admins_Email",
                table: "company_admins",
                column: "Email",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_drivers_Cpf_CompanyId",
                table: "drivers",
                columns: new[] { "Cpf", "CompanyId" },
                unique: true);
